...
int Menu()
{
    ...
    text1.setScale(0.8f, 0.8f);                                                       // переменный спрайтов
    text2.setScale(0.7f, 0.7f);                                                       // масштабы для надписей в Меню
    ...
    MenuSound.setVolume(60.f);                                                        // громкость
    ...
    text1.setPosition(15.f, 80.f);                                                    // расположение надписей на экране
